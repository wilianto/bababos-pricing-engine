...
type BasicPricingStrategyTestSuite struct {
	suite.Suite
}

func TestBasicPricingStrategyTestSuite(t *testing.T) {
	suite.Run(t, new(BasicPricingStrategyTestSuite))
}

func (s *BasicPricingStrategyTestSuite) TestGetPrice() {
	tests := []struct {
		name           string
		qty            int64
